...
- Mail 앱에 tr4401104@gmail.com 계정 추가 필요. **주의**: 이 Mac에선 계정 이름이 `Google`로 저장되어 있어서 `coupang_relogin.sh`의 `account "tr4401104@gmail.com"` 참조가 실패함 → 원본 수정 또는 Mail 앱 계정명 변경 필요 (2026-04-17 기준 미해결).
